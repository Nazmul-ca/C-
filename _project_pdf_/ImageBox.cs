...
namespace Cyotek.Windows.Forms
{
  ...
  #region  Protected Overridden Methods  
    ...
    // arif edit protected override void OnMouseClick
 ...
 protected override void OnMouseWheel(MouseEventArgs e)
  ...
  #region  Public Methods  
    ...
    public virtual void zoomformouseenter()
    {
        if (this.SizeToFit)
        {
            int previousZoom;
        ...
        if (this.Zoom >= 100)
            this.Zoom = (int)Math.Round((double)(this.Zoom + 100) / 170) * 100;
        else if (this.Zoom >= 85)
            this.ActualSize();
        else
            this.Zoom = (int)(this.Zoom / 0.90F);
    }
    /// <summary>
